      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <div className="mb-8">
            ...
            <p className="mt-1 text-sm text-[#888]">Sign in to your Folio account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                className="w-full text-[#000000] border border-[#CCCBC4] rounded-xl px-4 py-2.5 text-sm text-[#1A1A1A] outline-none focus:border-[#4A6CF7] focus:ring-2 focus:ring-[#4A6CF7]/10 bg-white transition-all placeholder:text-[#BBB]"
              />
            </div>
            ...
            <div className="flex flex-col gap-1.5">
              <div className="flex items-center justify-between">
                ...
                <Link href="/forgot-password" className="text-xs text-[#4A6CF7] hover:underline">
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full text-[#000000] border border-[#CCCBC4] rounded-xl px-4 py-2.5 pr-10 text-sm text-[#1A1A1A] outline-none focus:border-[#4A6CF7] focus:ring-2 focus:ring-[#4A6CF7]/10 bg-white transition-all placeholder:text-[#BBB]"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-2 w-full bg-[#1A1A1A] text-white py-2.5 rounded-xl text-sm font-medium hover:bg-[#333] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          <p className="mt-6 text-center text-sm text-[#888]">
            ...
            <Link href="/signup" className="text-[#4A6CF7] font-medium hover:underline">
              Sign up
            </Link>
          </p>
